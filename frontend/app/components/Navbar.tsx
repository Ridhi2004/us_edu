...
const menuData = {
  ...
  services: {
    ...
    items: [
      ...
      { label: "Travel Assistance", href: "/howWeWork/travel-assistance" },
      { label: "Pre-Departure Guidance", href: "/howWeWork/pre-departure-guidance" },
      { label: "Scholarships Guidance", href: "/howWeWork/scholarships-guidance" },
      { label: "Visa Assistance", href: "/howWeWork/visa-assistance" },
    ],
  },
  studyAbroad: {
    label: "Study Abroad",
